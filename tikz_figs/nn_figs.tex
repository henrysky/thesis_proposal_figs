...
\begin{document}
\begin{tikzpicture}
	\node[circle, draw, thick, label=left:{Input}] (i1) {};
	\node[circle, draw, thick, above=2em of i1, label=left:{Input}] (i2) {};
	\node[circle, draw, thick, above=2em of i2, label=left:{Input}] (i3) {};
	\node[circle, draw, thick, below=2em of i1, label=left:{Input}] (i4) {};
	\node[circle, draw, thick, below=2em of i4, label=left:{Input}] (i5) {};
	%
	...
	\node[circle, draw, thick, right=4em of hh4, label=right:{Output}] (o2) {};
	%
